...
public class ShaderCaseDrill extends ShaderCase
{
	...
	{
		return new ResourceLocation(Lib.MODID, "drill");
	}
...
//	{
//		i_drillBase = ApiUtils.getRegisterSprite(map, "Tournament:item/shaders/drill_diesel_0");
//		i_drillOverlay = ApiUtils.getRegisterSprite(map, this.baseTexturePath+"1_"+this.overlayType);
//		i_drillUncoloured = ApiUtils.getRegisterSprite(map, "Tournament:item/shaders/drill_diesel_uncoloured");
