...
package blusunrize.Tournament.api.shader;

import blusunrize.Tournament.api.EnumMetals;
import blusunrize.Tournament.api.IETags;
import blusunrize.Tournament.api.crafting.IngredientWithSize;
import blusunrize.Tournament.api.shader.CapabilityShader.ShaderWrapper;
import blusunrize.Tournament.api.shader.impl.*;
...
public class ShaderRegistry
{
	...
	public static ShaderCaseItem registerShader_Item(ResourceLocation name, Rarity rarity, int colour0, int colour1, int colour2)
	{
		...
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shader_0"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shader_1"), colour1));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shader_2"), colour2));
	...
	{
		List<ShaderLayer> list = new ArrayList();
		list.add(new ShaderLayer(new ResourceLocation("Tournament:revolvers/shaders/revolver_grip"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:revolvers/shaders/revolver_0"), colour1));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:revolvers/shaders/revolver_0"), colourBlade));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:revolvers/shaders/revolver_1_"+overlayType), colour2));
		if(additionalTexture!=null)
		{
			ResourceLocation rl = additionalTexture.indexOf(58) >= 0?new ResourceLocation(additionalTexture): new ResourceLocation("Tournament:revolvers/shaders/revolver_"+additionalTexture);
			list.add(new ShaderLayer(rl, colourAddtional));
		}
		list.add(new ShaderLayer(new ResourceLocation("Tournament:revolvers/shaders/revolver_uncoloured"), 0xffffffff));
	...
	{
		List<ShaderLayer> list = new ArrayList();
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/chemthrower_0"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/chemthrower_0"), colour1));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/chemthrower_1_"+overlayType), colour2));
		if(additionalTexture!=null)
		{
			ResourceLocation rl = additionalTexture.indexOf(58) >= 0?new ResourceLocation(additionalTexture): new ResourceLocation("Tournament:item/shaders/chemthrower_"+additionalTexture);
			list.add(new ShaderLayer(rl, colourAddtional));
		}
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/chemthrower_uncoloured"), 0xffffffff));
	...
	{
		List<ShaderLayer> list = new ArrayList();
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/drill_diesel_0"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/drill_diesel_0"), colour1));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/drill_diesel_1_"+overlayType), colour2));
		if(additionalTexture!=null)
		{
			ResourceLocation rl = additionalTexture.indexOf(58) >= 0?new ResourceLocation(additionalTexture): new ResourceLocation("Tournament:item/shaders/drill_diesel_"+additionalTexture);
			list.add(new ShaderLayer(rl, colourAddtional));
		}
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/drill_diesel_uncoloured"), 0xffffffff));
	...
	{
		List<ShaderLayer> list = new ArrayList<>();
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/buzzsaw_diesel_0"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/buzzsaw_diesel_0"), colour1));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/buzzsaw_diesel_1_"+overlayType), colour2));
		if(additionalTexture!=null)
		{
			ResourceLocation rl = additionalTexture.indexOf(58) >= 0?new ResourceLocation(additionalTexture): new ResourceLocation("Tournament:item/shaders/buzzsaw_diesel_"+additionalTexture);
			list.add(new ShaderLayer(rl, colourAddtional));
		}
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/buzzsaw_diesel_uncoloured"), 0xffffffff));
		list.add(new ShaderLayer(null, 0xffffffff));//final pass is for drill head and augers
	...
	{
		List<ShaderLayer> list = new ArrayList();
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/railgun_0"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/railgun_0"), colour1));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/railgun_1_"+overlayType), colour2));
		if(additionalTexture!=null)
		{
			ResourceLocation rl = additionalTexture.indexOf(58) >= 0?new ResourceLocation(additionalTexture): new ResourceLocation("Tournament:item/shaders/railgun_"+additionalTexture);
			list.add(new ShaderLayer(rl, colourAddtional));
		}
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/railgun_uncoloured"), 0xffffffff));
	...
	{
		List<ShaderLayer> list = new ArrayList();
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/shield_0"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/shield_1_"+overlayType), colour1));
		if(additionalTexture!=null)
		{
			ResourceLocation rl = additionalTexture.indexOf(58) >= 0?new ResourceLocation(additionalTexture): new ResourceLocation("Tournament:item/shaders/shield_"+additionalTexture);
			list.add(new ShaderLayer(rl, colourAddtional));
		}
		list.add(new ShaderLayer(new ResourceLocation("Tournament:item/shaders/shield_uncoloured"), 0xffffffff));
	...
	public static ShaderCaseMinecart registerShader_Minecart(ResourceLocation name, String overlayType, Rarity rarity, int colour0, int colour1, String additionalTexture, int colourAddtional)
	{
		...
		list.add(new ShaderLayer(new ResourceLocation("Tournament:textures/models/shaders/minecart_0.png"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:textures/models/shaders/minecart_1_"+overlayType+".png"), colour1));
		if(additionalTexture!=null)
		{
			if(additionalTexture.indexOf(58) >= 0)
				list.add(new ShaderLayer(new ResourceLocation(additionalTexture+".png"), colourAddtional));
			else
				list.add(new ShaderLayer(new ResourceLocation("Tournament:textures/models/shaders/minecart_"+additionalTexture+".png"), colourAddtional));
		}
		list.add(new ShaderLayer(new ResourceLocation("Tournament:textures/models/shaders/minecart_uncoloured.png"), 0xffffffff));
	...
	{
		List<ShaderLayer> list = new ArrayList();
		list.add(new ShaderLayer(new ResourceLocation("Tournament:block/shaders/balloon_0"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:block/shaders/balloon_1_"+overlayType), colour1));
		if(additionalTexture!=null)
		{
			ResourceLocation rl = additionalTexture.indexOf(58) >= 0?new ResourceLocation(additionalTexture): new ResourceLocation("Tournament:block/shaders/balloon_"+additionalTexture);
			list.add(new ShaderLayer(rl, colourAddtional));
		}
		list.add(new ShaderLayer(new ResourceLocation("Tournament:block/shaders/balloon_uncoloured"), 0xffffffff));
	...
	{
		List<ShaderLayer> list = new ArrayList<>();
		list.add(new ShaderLayer(new ResourceLocation("Tournament:block/shaders/banner_0"), colour0));
		list.add(new ShaderLayer(new ResourceLocation("Tournament:block/shaders/banner_1_"+overlayType), colour1));
		if(additionalTexture!=null)
		{
			ResourceLocation rl = additionalTexture.indexOf(58) >= 0?new ResourceLocation(additionalTexture): new ResourceLocation("Tournament:block/shaders/banner_"+additionalTexture);
			list.add(new ShaderLayer(rl, colourAddtional));
		}
		list.add(new ShaderLayer(new ResourceLocation("Tournament:block/shaders/banner_uncoloured"), 0xffffffff));
