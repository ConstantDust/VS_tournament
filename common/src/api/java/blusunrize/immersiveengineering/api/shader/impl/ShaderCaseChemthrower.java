...
public class ShaderCaseChemthrower extends ShaderCase
{
	...
	{
		return new ResourceLocation(Lib.MODID, "chemthrower");
	}
...
//	{
//		i_chemthrowerBase = ApiUtils.getRegisterSprite(map, "Tournament:item/shaders/chemthrower_0");
//		i_chemthrowerOverlay = ApiUtils.getRegisterSprite(map, this.baseTexturePath+"1_"+this.overlayType);
//		i_chemthrowerUncoloured = ApiUtils.getRegisterSprite(map, "Tournament:item/shaders/chemthrower_uncoloured");
