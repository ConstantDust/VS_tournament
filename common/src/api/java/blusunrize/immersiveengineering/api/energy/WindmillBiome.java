...
{
	public static RecipeType<WindmillBiome> TYPE;
	public static RegistryObject<IERecipeSerializer<WindmillBiome>> SERIALIZER;

	public static final CachedRecipeList<WindmillBiome> ALL_BIOMES = new CachedRecipeList<>(() -> TYPE, WindmillBiome.class);
