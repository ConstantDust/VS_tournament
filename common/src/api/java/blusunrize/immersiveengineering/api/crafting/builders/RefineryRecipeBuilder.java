...
import blusunrize.Tournament.api.crafting.FluidTagInput;
import blusunrize.Tournament.api.crafting.RefineryRecipe;
...
public class RefineryRecipeBuilder extends IEFinishedRecipe<RefineryRecipeBuilder>
{
	...
	public RefineryRecipeBuilder addInput(TagKey<Fluid> fluidTag, int amount)
	{
	...
	public RefineryRecipeBuilder addCatalyst(TagKey<Item> tag)
	{
