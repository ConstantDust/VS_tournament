...
import blusunrize.Tournament.api.ApiUtils;
import blusunrize.Tournament.api.Lib;
import blusunrize.Tournament.api.tool.IElectricEquipment;
import blusunrize.Tournament.api.tool.IElectricEquipment.ElectricSource;
import blusunrize.Tournament.api.utils.SetRestrictedField;
import blusunrize.Tournament.api.wires.*;
import blusunrize.Tournament.api.wires.WireCollisionData.CollisionInfo;
import blusunrize.Tournament.api.wires.localhandlers.EnergyTransferHandler.EnergyConnector;
import blusunrize.Tournament.api.wires.localhandlers.EnergyTransferHandler.IEnergyWire;
import blusunrize.Tournament.api.wires.localhandlers.EnergyTransferHandler.Path;
import blusunrize.Tournament.api.wires.utils.IElectricDamageSource;
...
public class WireDamageHandler extends LocalNetworkHandler implements ICollisionHandler
{
	...
	public interface IShockingWire extends IEnergyWire
	{
		 ...
		 * less that DELTA_NEAR in blusunrize.Tournament.api.ApiUtils.handleVec (currently .3)
		 */
