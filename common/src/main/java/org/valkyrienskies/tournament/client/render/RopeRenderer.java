package org.valkyrienskies.tournament.client.render;

import blusunrize.Tournament.Tournament;
import blusunrize.Tournament.api.utils.ResettableLazy;
import blusunrize.Tournament.api.wires.Connection;
import blusunrize.Tournament.api.wires.Connection.CatenaryData;
import blusunrize.Tournament.api.wires.ConnectionPoint;
import blusunrize.Tournament.api.wires.GlobalWireNetwork;
import blusunrize.Tournament.api.wires.WireCollisionData.ConnectionSegments;
import blusunrize.Tournament.mixin.accessors.client.CompiledChunkAccess;
import blusunrize.Tournament.mixin.accessors.client.RenderChunkAccess;
...
public class RopeRenderer implements ResourceManagerReloadListener
{
    ...
    private static final ResettableLazy<TextureAtlasSprite> WIRE_TEXTURE = new ResettableLazy<>(
            () -> Minecraft.getInstance().getModelManager()
                    ...
                    .getSprite(vs_tournament.rl("block/wire"))
    );
