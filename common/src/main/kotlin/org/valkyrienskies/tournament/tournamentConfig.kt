...
object tournamentConfig {
    ...
    class Server {
        ...
        var BaseHeight : Double = 100.0

        @JsonSchema(description = "The Force a spinner will output")
        var SpinnerSpeed : Double = 5000.0

        @JsonSchema(description = "The Force a balloon will output")
        var BalloonPower : Double = 30.0

        @JsonSchema(description = "The Force a spinner will output")
        var ThrusterSpeed : Double = 10000.0
        ...
        var ballastNoWeight : Double = 10.0

        @JsonSchema(description = "The Force the Pulse Gun applies")
        var pulseGunForce : Double = 300.0
